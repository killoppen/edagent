...
def registry_manifest() -> dict[str, Any]:
    ...
    payload = {
        ...
        "authority": {
            ...
            "learning_path_source_contract": "LearnFlow-owned learnflow-learning-path/v1 and versioned learnflow-learning-path/v2 source graphs; Role Atlas consumes immutable v1/v2 exports, role bindings and extension proposals without direct learner-state or Kernel writes",
